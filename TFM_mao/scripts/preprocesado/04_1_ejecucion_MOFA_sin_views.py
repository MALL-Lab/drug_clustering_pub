...
OUTPUT_PARQUET_TIDY = "/mnt/netapp2/Store_uni/home/ulc/co/mao/TFM_final/datos/datos_con_placa_14/tidy_final_sin_views.parquet"
    ...
    check = con.query(f"""
        SELECT 
            ...
            COUNT(*) - COUNT(DISTINCT 
                CONCAT(gene_name,'||', drug, '||',"Cell_Name_Vevo", '||',
